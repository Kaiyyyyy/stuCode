...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				//在spring的环境中去执行已经被注册的 beanFacyoryPostProcessors
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		...
		// 	a、postProcessBeanDefinitionRegistry方法早于postProcessBeanFactory方法执行，对于postProcessBeanDefinitionRegistry的执行顺序又遵循如下原子
		...
		//	b、 执行完所有的postProcessBeanDefinitionRegistry方法后，再执行实现了BeanDefinitionRegistryPostProcessor接口的类中的postProcessBeanFactory方法
		...
		//到目前为止容器还没有进行扫描，getBeanFactoryPostProcessors()只能获得程序猿手动添加
		//的某些BeanFactoryPostProcessor,即AnnotationConfigApplicationContext.addBeanFactoryPostProcessor()添加进来的类.
		//getBeanFactoryPostProcessors()是在一个list去拿，这个list是在AnnotationConfigApplicationContext被定义是创建的
