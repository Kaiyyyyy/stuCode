...
//	private NacosRegistration nacosRegistration;
	...
	public Object client(@PathVariable String service) throws Exception{
		NamingService namingService = nacosDiscoveryProperties.namingServiceInstance();
		nacosDiscoveryProperties.namingServiceInstance().getAllInstances("service-provider");
		List<Instance> allInstances = namingService.getAllInstances(nacosDiscoveryProperties.getService());
