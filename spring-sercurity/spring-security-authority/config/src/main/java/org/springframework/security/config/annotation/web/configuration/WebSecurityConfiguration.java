...
public class WebSecurityConfiguration implements ImportAware, BeanClassLoaderAware {
	...
	/**
	 * 函数接口，一个输入没有输出WebSecurityCustomizer.customize(WebSecurity web);
	 */
	...
	public Filter springSecurityFilterChain() throws Exception {
		// 判断webSecurityConfigurers(WebSecurityConfigurer.class的集合)是否为空
		// 如果为空下面默认生成一个WebSecurityConfigurerAdapter
		...
		if (!hasConfigurers && !hasFilterChain) {
			...
			//放入WebSecurity的configurers属性
			this.webSecurity.apply(adapter);
		}
		//返回第一个FilterSecurityInterceptor
	...
	public void setFilterChainProxySecurityConfigurer(ObjectPostProcessor<Object> objectPostProcessor,
		...
		//将所有的缓存到WebSecurity的configurers属性中
