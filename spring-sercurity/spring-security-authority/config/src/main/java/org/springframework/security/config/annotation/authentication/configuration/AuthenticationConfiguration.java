...
public class AuthenticationConfiguration {
	...
	public AuthenticationManager getAuthenticationManager() throws Exception {
		...
		// 2  build 方法调用同授权过程中的 webSecurity.build()  一样，都是通过父类 AbstractConfiguredSecurityBuilder.doBuild() 方法中的
		// performBuild() 方法进行 build, 只是这里不再是通过其子类 HttpSecurity.performBuild() ，而是通过 AuthenticationManagerBuilder.performBuild()
